# Oswego Weather Center Official Update History

**v0.1.0 09/21/2025**: Initial website release


**v1.0.0 11/14/2025 (1)**: Official website release to SD308


**v1.1.0 11/14/2025 (2)**: Abbreviation list complete


**v1.2.0 11/16/2025**: Made changes with the SPC Products page


**v1.2.1 11/17/2025 (1)**: Fixed capitalization errors and added a new section labeled "List of Documented Tornadoes in the KLOT Region"


**v1.3.0 11/17/2025 (2)**: Added subpages for each county in the KLOT region and began listing tornadoes for Boone County


**v1.4.0 11/17/2025 (3)**: Added hyperlinks for each county under the section "List of Documented Tornadoes in the KLOT Region", and started with documents for each tornado in Boone County
...
**v1.5.3 11/20/2025 (1)**: Not an official update on the website, but currently learning HTML and Python within GitHub


**v1.5.4 11/20/2025 (2)**: Changed contact email from "23002105@students.sd308.org" to "jackmartinminer@gmail.com"
